package com.mate.system.aspect;
...
import com.mate.core.common.exception.PreviewException;
import com.mate.core.common.util.RequestHolder;
import com.mate.core.common.util.TraceUtil;
...
public class PreviewAspect {
    ...
    @Around(
            "execution(static com.mate.core.common.api.Result *(..)) || " +
